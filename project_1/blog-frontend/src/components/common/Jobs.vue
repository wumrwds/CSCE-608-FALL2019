        ...
        <el-scrollbar class="page-component__scroll">
            <el-main>
                <el-breadcrumb separator="/">
                    ...
                    <el-breadcrumb-item :to="{path:'/jobs'}">User List</el-breadcrumb-item>
                </el-breadcrumb>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        label="EEE">
                        <template slot-scope="scope">
                            {{scope.row.durationStr | nullToDash}}
                        </template>
                    </el-table-column>
                    <el-table-column
                        align="center"
                    ...
                    <el-table-column label="GGG" min-width="200" align="center">
                        <template slot-scope="scope">
                        <el-button
                            size="mini"
                            @click="queryJobProcess(scope.row.id)">运行情况</el-button>
                        <el-button
                            size="mini"
                            type="danger"
                            @click="queryErrorLogsByJob(scope.row.id)">错误日志</el-button>
                        </template>
                    </el-table-column>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        queryJobs () {
            ...
            if (this.taskId !== null && this.taskId !== undefined && this.taskId.split(" ").join("").length !== 0) {
    ...
    mounted () {
        if (this.$route.params.taskId !== undefined && this.$route.params.taskId !== null) {
            this.taskId = this.$route.params.taskId.toString()
        }
